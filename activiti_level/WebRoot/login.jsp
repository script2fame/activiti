...
<body style="text-align: center;">
	<form action="loginAction_login.action" method="post">
		<table width="100%" height="100%" border="0" cellspacing="0"
			...
			<tr>
				<td height="608" background="${basePath}/images/login_03.gif"><table
							...
							<td height="84"><table width="100%" border="0"
									...
									<tr>
										<td width="381" height="84"
											background="${basePath}/images/login_06.gif">&nbsp;</td>
										<td width="200" valign="middle"
											background="${basePath}/images/login_07.gif"><table
										...
										<td width="26"><img src="${basePath}/images/login_08.gif"
											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													<td height="25"><div align="center"
															...
															<img src="${basePath}/images/dl.gif" width="57"
																height="20">
														</div></td>
												</tr>
											</table>
